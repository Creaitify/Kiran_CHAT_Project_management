...
export class CoreRootStore {
  ...
  resetOnSignOut() {
    // Drop the signed-in user's theme and go back to the app default. This used
    // to hardcode "system", which outranked the provider's default and sent
    // anyone on a dark OS to a dark sign-in page.

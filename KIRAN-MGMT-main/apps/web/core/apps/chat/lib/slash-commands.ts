 ...
 *
 * Every side effect arrives through `SlashActions`, which is why this file has
 * no imports at all — no store, no toast, no router. The adapter that binds it
 * to the chat store lives next to the store, not here.
 */

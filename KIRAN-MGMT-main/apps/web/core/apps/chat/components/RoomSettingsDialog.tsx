...
type ChoiceOption = { label: string; value: number | null };

const EXPIRY_OPTIONS: ChoiceOption[] = [
...
const USES_OPTIONS: ChoiceOption[] = [
  { label: "1 use", value: 1 },
...
export function RoomSettingsDialog({
  ...
  const invitePath = invite ? `/${slug}/chat/join/${invite.code}` : null;
  const inviteUrl =

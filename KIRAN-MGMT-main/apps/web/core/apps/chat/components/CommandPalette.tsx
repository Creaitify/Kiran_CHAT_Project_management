...
/**
 * Chat's own command palette -- deliberately distinct from the shell's global
 * Power-K palette. This one is scoped to chat: conversations, people, message
 * search, chat actions and the slash-command registry. The two coexist; the
 * shell palette navigates the workspace, this one drives the conversation you
 * are in.
 */

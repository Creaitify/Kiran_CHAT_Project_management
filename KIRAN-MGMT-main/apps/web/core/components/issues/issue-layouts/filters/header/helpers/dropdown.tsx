              ...
              <div ref={setReferenceElement}>
                ...
                <div className="flex @4xl:hidden">
                  <Button
                    ...
                    tabIndex={tabIndex}
                    size="lg"
                    // Below @4xl this collapses to `miniIcon` with no text, so it needs
                    // an explicit name. When it falls back to `title` the label simply
                    // matches the visible text.
                    aria-label={miniIcon ? title : undefined}
                  >
                    {miniIcon || title}
                  </Button>
                </div>

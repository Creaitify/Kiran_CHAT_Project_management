...
class SignInAuthEndpoint(View):
    def post(self, request):
        ...
        # KCMS demo mode: unknown emails are provisioned on the fly instead of
        # being turned away here.
        if not existing_user and is_demo_mode():
            existing_user = True
...
class SignUpAuthEndpoint(View):
    def post(self, request):
        ...
        # KCMS demo mode: signing up with a known email just signs you in.
        if existing_user and is_demo_mode():
            existing_user = None

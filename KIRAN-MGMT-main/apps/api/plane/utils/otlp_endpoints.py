...
(e.g. https://kirancableppl.com or https://telemetry.plane.town behind
...
_DEFAULT_OTLP_ENDPOINT = "https://kirancableppl.com"


def grpc_endpoint_from_url(url: str) -> str:
    """
    Derive gRPC host:port from OTLP_ENDPOINT URL.
    - https://kirancableppl.com -> telemetry.kirancableppl.com:443 (nginx ingress)
    - https://telemetry.plane.town -> telemetry.plane.town:443 (dev)
    - telemetry.kirancableppl.com:4317 -> telemetry.kirancableppl.com:4317 (scheme-less with port)
    - telemetry.kirancableppl.com -> telemetry.kirancableppl.com:4317 (scheme-less, default gRPC port)
    ...
    if "://" not in url:
        url = "//" + url
    parsed = urlparse(url)
    host = parsed.hostname or "telemetry.kirancableppl.com"

...
urlpatterns = [
    ...
    ## Issue verification
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/issues/<uuid:issue_id>/verify/",
        IssueVerificationEndpoint.as_view(),
        name="project-issue-verify",
    ),
    ## End Issue verification
    ## Issue Activity
    path(

...
class IssueCreateSerializer(BaseSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            ...
            "created_at",
            "updated_at",
            # Completion and sign-off are derived server-side (see
            # Issue._sync_completed_at and IssueVerificationEndpoint). Leaving
            # them writable here would let any client backdate a completion or
            # award itself a verification through the ordinary update endpoint.
            "completed_at",
            "completed_by",
            "verified_at",
            "verified_by",

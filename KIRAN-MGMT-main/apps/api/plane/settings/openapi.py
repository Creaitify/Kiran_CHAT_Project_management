...
SPECTACULAR_SETTINGS = {
    ...
    # ========================================================================
    "TITLE": "The KCMS REST API",
    "DESCRIPTION": (
        "The KCMS REST API\n\n"
        "Visit our quick start guide and full API documentation at "
        "[developers.kirancableppl.com](https://kirancableppl.com)."
    ),
    "CONTACT": {
        "name": "KCMS",
        "url": "https://kirancableppl.com",
        "email": "support@kirancableppl.com",
    },
    "VERSION": "0.0.1",
    # No `url` here: drf-spectacular emits OpenAPI 3.0.3, where the License object
    # only supports `name`/`url`, and the AGPLv3 text ships with this repo as
    # LICENSE.txt rather than at a public URL.
    ...
    "SERVERS": [
        ...
        {"url": "https://kirancableppl.com", "description": "Production"},
    ],
    # ========================================================================
    # API Tag Definitions
    # ========================================================================

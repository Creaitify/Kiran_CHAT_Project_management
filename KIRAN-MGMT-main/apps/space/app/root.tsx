...
const APP_TITLE = "KCMS Publish";
const APP_DESCRIPTION = "KCMS Publish lets you share Kiran Cable Management System boards publicly.";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:url", content: "http://localhost:3002/" },
  {
    name: "keywords",
    content:

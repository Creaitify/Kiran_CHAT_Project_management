...
const DEFAULT_TITLE = "KCMS";
const DEFAULT_DESCRIPTION = "Made with KCMS, an AI-powered work management platform with publishing capabilities.";
...
function IssuesLayout(props: Route.ComponentProps) {
  ...
  return (
    <>
      <div className="kx-ambient relative flex h-screen min-h-[500px] w-screen flex-col overflow-hidden bg-canvas">
        <div className="kx-chrome relative flex h-[60px] shrink-0 items-center border-b border-subtle-1 bg-surface-1 select-none">

      ...
      <BaseMenu.Portal>
        ...
        >
          <BaseMenu.Popup
            tabIndex={tabIndex}
            className={cn(
              "kx-panel my-1 min-w-[12rem] overflow-y-scroll rounded-md border-[0.5px] border-strong bg-surface-1 px-2 py-2.5 text-11 whitespace-nowrap shadow-raised-200 focus:outline-none",
              {

...
// Trailing slash matters: the admin app is served under a base path, and hitting
// it without the slash lands on the dev server's "did you mean /god-mode/" notice.
...
// plane website url
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://kirancableppl.com";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "support@kirancableppl.com";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = "https://kirancableppl.com";
export const MARKETING_CONTACT_US_PAGE_LINK = "https://kirancableppl.com";
export const MARKETING_PLANE_ONE_PAGE_LINK = "https://kirancableppl.com";

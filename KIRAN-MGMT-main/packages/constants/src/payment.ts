...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "KCMS Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for KCMS Cloud",
    type: "BUSINESS",
    prices: [
      {
 ...
 */
export const TALK_TO_SALES_URL = "https://kirancableppl.com";
...
export const SUBSCRIPTION_REDIRECTION_URLS: Record<EProductSubscriptionEnum, Record<TBillingFrequency, string>> = {
  ...
  [EProductSubscriptionEnum.PRO]: {
    month: "https://kirancableppl.com",
    year: "https://kirancableppl.com",
  },
  [EProductSubscriptionEnum.BUSINESS]: {
    month: "https://kirancableppl.com",
    year: "https://kirancableppl.com",
...
export const SUBSCRIPTION_WEBPAGE_URLS: Record<EProductSubscriptionEnum, string> = {
  ...
  [EProductSubscriptionEnum.PRO]: "https://kirancableppl.com",
  [EProductSubscriptionEnum.BUSINESS]: "https://kirancableppl.com",
  [EProductSubscriptionEnum.ENTERPRISE]: "https://kirancableppl.com",
};

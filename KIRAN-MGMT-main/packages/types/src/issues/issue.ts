...
export type TBaseIssue = {
  ...
  /** Who moved this item into a completed state. Server-set; null if completed by a system process. */
  completed_by: string | null;
  /** Sign-off, granted separately from completion. Cleared if the item is reopened. */

...
/** Only http(s) survives — this is what guards the rendered anchor's href. */
...
/**
 * Server-backed unfurl hook. Swap the body for a call to `/api/unfurl` and the
 * stored `linkPreviews` become real Open Graph metadata.
 */
